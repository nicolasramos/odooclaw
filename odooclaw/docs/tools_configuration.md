...
OdooClaw's tools configuration is located in the `tools` field of `config.json`.
...
By default, OdooClaw blocks the following dangerous commands:
...
- `ODOOCLAW_TOOLS_WEB_BRAVE_ENABLED=true`
- `ODOOCLAW_TOOLS_EXEC_ENABLE_DENY_PATTERNS=false`
