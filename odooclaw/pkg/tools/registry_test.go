...
func TestToolRegistry_ExecuteWithContext_ContextualTool(t *testing.T) {
	...
	r.ExecuteWithContext(context.Background(), "ctx_tool", nil, "telegram", "chat-42", "", nil, nil)
...
func TestToolRegistry_ExecuteWithContext_SkipsEmptyContext(t *testing.T) {
	...
	r.ExecuteWithContext(context.Background(), "ctx_tool", nil, "", "", "", nil, nil)
...
func TestToolRegistry_ExecuteWithContext_AsyncCallback(t *testing.T) {
	...
	result := r.ExecuteWithContext(context.Background(), "async_tool", nil, "", "", "", nil, cb)
	if at.cb == nil {
