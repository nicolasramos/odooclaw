...
// DefaultConfig returns the default configuration for OdooClaw.
func DefaultConfig() *Config {
	// Determine the base path for the workspace.
	// Priority: $ODOOCLAW_HOME > ~/.odooclaw
	var homePath string
	if odooclawHome := os.Getenv("ODOOCLAW_HOME"); odooclawHome != "" {
		homePath = odooclawHome
	} else {
		userHome, _ := os.UserHomeDir()
		homePath = filepath.Join(userHome, ".odooclaw")
	}
